        ...
        if (this.color == 0){
            ...
            if (sceneCount ==1.5) {
             ...
             if (this.origin.x == 0 && this.origin.y == 0) {
                ...
                this.position2.y=((s+110+3)+this.botz*this.botz*(8.8)*0.2)*s_y
                ...
                this.position2.y=((s+this.origin.y+1+113-line_green[0][1]-array_band2[0])+this.botz*this.botz*(8.8)*0.2)*s_y
